      ...
      <div className="main-content-container">
        <div className="content-highlight">
          <p className="content-paragraph-large">
            ...
            blijven in het lichaam aanwezig en bepalen hoe je je voelt, reageert en presteert.
          </p>
          <p className="content-paragraph-large">
            In mijn praktijk voor Brainspotting + ISTDP richten we ons direct op deze sporen in het 
          ...
          <div className="content-cta">
            <Link to="/perspectief" className="btn btn-primary">Lees meer over dit perspectief</Link>
          </div>
        </div>
      </div>
    </section>
