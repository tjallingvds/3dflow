...
function Praktisch() {
  ...
  const translations = {
    ...
    EN: {
      ...
      availability: 'I\'m generally available on short notice. Appointments can be scheduled on any weekday and if needed on evenings and weekends.',
