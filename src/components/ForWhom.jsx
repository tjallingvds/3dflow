    ...
    EN: {
      ...
      sections: {
        ...
        hoogbegaafd: {
          ...
          p1: 'I work extensively with gifted and highly gifted individuals. Most gifted people experience repeated rejection from an early age because they are so often misunderstood. That not only causes pain but also creates protective patterns - emotional numbing, living in the head, shutting down, or rationalizing - which hinder development and connection and can become so powerful that it\'s hard to get through them. As someone who is highly gifted myself and through the combination of techniques I use - with which protection patterns are no hindrance but precisely lead the way to both the problem and the solution - we can always access the underlying material so obstacles will resolve and you can reach your full potential in everything you do.',
        ...
        prestatie: {
          ...
          p1: 'The essential difference between competent and genius - or between something that is merely good and something that touches you to the core - goes beyond skills. Exceptional qualities require a different approach to develop them: think a racehorse vs. a school horse, a racing car vs. a family car. The attunement to individuality must be so much more refined. Top performance in any field cab only emerge where excellent skills come together with a state of free, unobstructed flow. Free access to intuition, reflexes, creativity, imagination, flow and inspiration is about the person beneath the performance. Your performances are founded on who you are, with everything you carry with you. Anything that restricts you as a person also limits your performance. Anything you resolve at that level strengthens the foundation of your performance in ways that training and practice alone can never reach. Even a limited amount of sessions working together can provide a huge boost to your performance and make the rest of your efforts far more effective.',
