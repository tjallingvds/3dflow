...
function Brainspotting() {
  ...
  const translations = {
    ...
    EN: {
      ...
      brainspotting2: 'Brainspotting has developed out of EMDR, the most widely used evidence-based trauma therapy. A fundamental difference from EMDR is that Brainspotting focuses on what you are experiencing in your body in the momentand follows that experience, rather than focusing on a specific traumatic image. By tracking moment-to-moment experience you are always exactly at the core of the issue and everything associated with it emerges naturally. Another important difference is that Brainspotting is aimed at creating the conditions under which the body\'s own processing restarts and let it unfold in attentively attuned awareness; there is no directed intervention as in EMDR. In the body-driven process, regulation, healing and growth naturally flow together, so resolving symptoms simultaneously produces fundamental development, performance enhancement and better connection with yourself and others.',
      istdpTitle: 'ISTDP',
