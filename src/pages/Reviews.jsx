...
function Reviews() {
  ...
  const reviewsNL = [
    {
      id: 1,
      text: "Ik vond Irene via Google toen ik op zoek was naar hulp voor mijn 9-jarige hoogbegaafde zoon. Door problemen op school en een negatieve ervaring met zijn leerkracht stonden we allebei onder grote stress. Ik besloot eerst zelf sessies te volgen om te ervaren hoe het werkte. Dat beviel me zo goed dat ik nog een paar sessies ben doorgegaan. Mijn angstaanvallen stopten vrij snel en hoewel mijn zoon Irene nooit heeft ontmoet, verbeterde zijn situatie ook enorm. Hij mag zijn leerkracht nog steeds niet, maar hij weigert niet langer om naar school te gaan en leert om te gaan met de uitdagingen die hij tegenkomt. Irene is heel vriendelijk en uiterst professioneel. Ik voelde me veilig om met haar te praten en ik ben dankbaar dat de sessies mij en mijn zoon zo goed hebben geholpen."
    },
    {
      id: 2,
    ...
    {
      id: 5,
      text: "Ik kwam naar de brainspotting-sessie om te werken met de spanning rondom spreken voor een grote groep. En ik verliet de ruimte met een onverwachte bonus. Ik zou het lichtheid noemen: een buitengewone lichtheid in mijn lichaam en in mijn gedachten. Als CEO neem ik elke dag een groot aantal beslissingen, van eenvoudig tot zeer complex. Vaak draag ik verantwoordelijkheid in situaties van onzekerheid en dat brengt angst met zich mee, die energie wegzuigt. Na de sessie met Irene voel ik me aan het einde van de dag energiek, terwijl mijn werkverantwoordelijkheden niet zijn veranderd. Dit was een zeer betekenisvolle verandering die de productiviteit verhoogt en mijn leven aangenamer maakt."
    },
    {
      id: 6,
      text: "Mijn angst is weg en alles gaat gewoon heel goed. Het voelt lichter en contacten met anderen zijn veel fijner. Ik had niet gedacht dat ik me ooit zo zou kunnen voelen!"
    },
    {
      id: 7,
      text: "Ik heb mijn kind weer terug! Haar somberheid is weg en we hebben weer contact! Wij zijn enthousiast!"
    },
    {
      id: 8,
  ...
  const reviewsEN = [
    {
      id: 1,
      text: "I found Irene on Google while searching for help with my 9 year old gifted son. Due to challenges at school and a negative experience with his teacher we were both under a lot of stress. I decided to start with my own sessions first to see how it worked and I really enjoyed it so decided to continue for a few more times. I stopped having anxiety episodes quite quickly, and although my son never met Irene things improved so much for  him too. He still doesn't like his teacher but no longer refuses going to school and is learning to deal with the challenges as they come. Irene is very kind and super professional. I felt comfortable talking to her and I am grateful the sessions helped me and my son so much."
    },
    {
      id: 2,
    ...
    {
      id: 5,
      text: "I came to the brainspotting session to work on anxiety about speaking in front of a crowd. And I left the room with an unexpected bonus. I would call it the lightness, the extraordinary lightness in my body and in my thought. As a CEO I am taking a number of decisions every day, from a simple one to very complex. Often I hold responsibility in the situation of uncertainty and this brings anxiety, sucking the energy. After the session with Irene, I feel brisk at the end of the day despite my work responsibilities have not changed. This was a very significant change that raises productivity and makes my life more enjoyable."
    },
    {
      id: 6,
      text: "My anxiety is gone and everything is simply going really well. Life feels lighter, and interactions with others are much more pleasant too. I never thought I could feel this way!"
    },
    {
      id: 7,
      text: "I have my child back! She is no longer feeling down and we are connected again. We are so happy!"
    },
    {
      id: 8,
      text: "Irene helped me enormously. I'd struggled for years with deep trauma and many life events that left me feeling torn and not knowing what I wanted. Through multiple sessions she cleared the blockages in a way no one else could. The process with Irene and Brainspotting was profoundly deep and reached the absolute core. I had nearly given up hope after many therapies, but with Irene everything was cleared. I feel more energetic, more free and happier than ever. Her strengths are sensitivity, attentiveness and depth in sessions. You don't have to talk if you don't want to; Brainspotting is a physical process that activates the body's self-organizing and healing capacities so the effects continue beyond the session. I highly recommend Irene."
    },
    {
      id: 9,
