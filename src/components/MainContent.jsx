  ...
  return (
    <section className="main-content">
      <div className="main-content-container">
        ...
        <div className="content-block metaphor-section">
          <div className="metaphor-content">
            <div className="metaphor-intro">
              <h3 className="metaphor-title">Het principe van co-regulatie</h3>
            </div>
            <p className="content-paragraph">
            ...
            <div className="metaphor-highlight">
              <p className="content-paragraph emphasis">
        ...
        <div className="content-block">
          <p className="content-paragraph">
            En je hoeft niet precies te weten wàt het is, om te ervaren dàt het er is. Iedere 
